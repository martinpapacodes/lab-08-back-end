...
// function locationSearch(request, response) {
//   const userRequest = request.query.data;
//   let searchResult = locationDBCheck(userRequest, response)
//     if(!searchResult){
//       superAgent.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${userRequest}&key=${process.env.GEOCODING_API_KEY}`).then(responseData => {
//         const locationResult = responseData.body.results[0];
//         const newLocation = new Location(userRequest, locationResult);
//         storeNewLocation(newLocation, userRequest);
...
// function locationDBCheck(request, response){
//   const DB = 'SELECT * FROM locations WHERE search_query = $1';
//   let checkResult = dbSearch(DB, request)
//     if(checkResult){
//       console.log(`Result found @ LOCATION==========================================================================`);
//       response.send(checkResult[0]);
//     }
//   };
